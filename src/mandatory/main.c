...
int main() 
{
	...
	game.textures.south.img = mlx_xpm_file_to_image(game.mlx, "./textures/wall1.xpm", &game.textures.south.width,  &game.textures.south.height);
	...
	game.textures.west.img = mlx_xpm_file_to_image(game.mlx, "./textures/wall1.xpm", &game.textures.west.width,  &game.textures.west.height);
	...
	game.textures.east.img = mlx_xpm_file_to_image(game.mlx, "./textures/wall1.xpm", &game.textures.east.width,  &game.textures.east.height);
